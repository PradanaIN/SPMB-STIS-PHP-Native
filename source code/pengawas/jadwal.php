...
if (!isset($_SESSION["pengawas"])) {
    // session "penagwas" = false, arahkan ke login 
...
/* ==================== NOTE ==================== */
/*
* Halaman ini baru template saja
* Dapat dikembangkan menjadi To Do List
*/
/* ==================== NOTE ==================== */
...
<head>
    ...
    <link rel="stylesheet" href="../static/css/jadwal.css">
</head>
<body>
