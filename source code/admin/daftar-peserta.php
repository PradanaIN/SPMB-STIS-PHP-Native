...
<body>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button>
                                    <a href="edit-peserta.php?id=<?= $row["id"]; ?>">
                                        <i class="fa-solid fa-edit"></i>
                                    </a>
                                </button>
                                <button>
                                    <a href="hapus-peserta.php?id=<?= $row["id"]; ?>" onclick="return confirm('Hapus data terpilih?')">
    ...
    <script src="../static/js/peserta.js"></script>
