    ...
    if (tambah_pengawas($_POST) > 0) {
        ...
        echo "
            <script>
                ...
                document.location.href = 'tambah-pengawas.php';
            </script>
        ";
    }
}
                        ...
                        <div class="details ID">
                            ...
                            <div class="fields">
                                ...
                                <div class="input-field">
                                    ...
                                    <select id="lokasi_1" name="lokasi_1" required>
                                ...
                                <div class="input-field">
                                    ...
                                    <select id="lokasi_2" name="lokasi_2">
                                        <option disabled selected>Pilih Lokasi</option>
                                        <option value="Zoom 001 - Sesi 1">Zoom 001 - Sesi 1</option>
                                        <option value="Zoom 001 - Sesi 2">Zoom 001 - Sesi 2</option>
                                        <option value="Zoom 001 - Sesi 3">Zoom 001 - Sesi 3</option>
                                ...
                                <div class="input-field">
                                    ...
                                    <select id="lokasi_3" name="lokasi_3">
                                        <option disabled selected>Pilih Lokasi</option>
                                        <option value="Zoom 001 - Sesi 1">Zoom 001 - Sesi 1</option>
                                        <option value="Zoom 001 - Sesi 2">Zoom 001 - Sesi 2</option>
                                        <option value="Zoom 001 - Sesi 3">Zoom 001 - Sesi 3</option>
