                ...
                <div class="peserta-shortcut">
                    <div class="peserta-header">
                        <div class="daftar-peserta">
                            ...
                            <p><?php echo count($pengawas);?> Pengawas Tahap Ini</p>
                        </div>
                    </div>
                    <div class="peserta-content">
                        <ul>
                            <?php foreach (array_slice($pengawas, 0, 7) as $row) : ?>
                            <li>
